...
public class CompanyServiceImpl implements CompanyService {
    ...
    @Override
    public List<CompanyResponse> findAllCompanies(String companyName,String companyPhone,String region,String city,String rank) {
        return companyMapper.findAllCompanies(companyName,companyPhone,region,city,rank);
    }
