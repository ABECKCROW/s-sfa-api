...
INSERT INTO sales_persons (sales_person_name) VALUES
('安部'), ('山田'), ('佐藤'), ('鈴木');

INSERT INTO companies (company_name, company_region, company_city, company_phone, company_rank, sales_person_id) VALUES
('ABECK株式会社', '神奈川県', '川崎市', 1234567890, "S", 1),
('Disk株式会社', '神奈川県', '厚木市', 1234567890, "A", 1),
('マウンテン株式会社', '神奈川県', '箱根町', 1234567890, "B", 2),
('シュガー株式会社', '神奈川県', '綾瀬市', 1234567890, "C", 3);
